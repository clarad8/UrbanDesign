...
# Configuration
DATA_PATH = 'C:\\Users\\Emily Shao\\Downloads\\Train_ANN\\'
BINARY_PATH = 'C:\\Users\\Emily Shao\\Box\\6 Spring 2024 - Study Abroad\\Artifical Neural Networks\\UrbanDesign\\\Binary\\'
OUTPUT_PATH = 'C:\\Users\\Emily Shao\\Downloads\\Output\\'
EPOCHS = 1000
BATCH_SIZE = 32
BUFFER_SIZE = 60000
...
if not os.path.isfile(training_binary_path):
    ...
    training_data = np.reshape(
        training_data, (-1, GENERATE_SQUARE, GENERATE_SQUARE, IMAGE_CHANNELS))
...
generator_optimizer = tf.keras.optimizers.Adam(0.05, 0.5)
discriminator_optimizer = tf.keras.optimizers.Adam(0.05, 0.5)
...
# first_element = next(iter(train_dataset.take(1)), None)
# empty = first_element is None
# print(empty)

# print(train_dataset==True)
